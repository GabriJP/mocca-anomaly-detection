...
nohup python fed.py server --port 50011 --num_rounds 100 --epochs 2 --warm_up_n_epochs=0 --proximal_mu 1 --min_evaluate_clients 0 --min_available_clients 13 --wandb_group "${GID}" --test_checkpoint 5 >"${GID}_server.log" 2>&1 </dev/null &
echo "Delay"
sleep 5
