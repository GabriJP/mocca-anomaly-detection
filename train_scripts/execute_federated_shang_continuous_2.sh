...
GID=${1:-"continuous2"}
COMMON_OPTS="citic:8081 --load-lstm --n_workers 2 --bidirectional --clip-length=16 --code-length=512 --dropout=0.3 --idx-list-enc=3,4,5,6 --parallel --continuous --min_evaluate_clients 1 --wandb_group ${GID}"
