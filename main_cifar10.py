...
from models.cifar10_model import CIFAR10_Autoencoder
from models.cifar10_model import CIFAR10_Encoder
from trainers.train_cifar10 import pretrain
from trainers.train_cifar10 import test
from trainers.train_cifar10 import train
from utils import get_out_dir
from utils import purge_ae_params
...
def main(args):
    ...
    data_holder = DataManager(
        dataset_name="cifar10", data_path=args.data_path, normal_class=args.normal_class, only_test=args.test
    ).get_data_holder()
    ...
    if args.pretrain:
        ...
        tb_writer = SummaryWriter(
            os.path.join(args.output_path, "cifar10", str(args.normal_class), "tb_runs/pretrain", tmp)
        )
    ...
    if args.train:
        ...
        tb_writer = SummaryWriter(
            os.path.join(args.output_path, "cifar10", str(args.normal_class), "tb_runs/train", tmp)
        )
